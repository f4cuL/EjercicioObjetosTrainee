...
public class auto {
	...
	boolean mostrarAuto(boolean cilindrada)
	{
		...
		if (cilindrada==false)
		{
			System.out.println("Marca: "+ marcaAuto +" // Modelo: " + modeloAuto +" // Puertas: "+ cantPuertas + " // Precio: $"+ precioMostrar);
			return true;
		}
		else
		{
			System.out.println("Marca: "+ marcaAuto +" // Modelo: " + modeloAuto +" // Cilindrada: "+ cilindradaAuto + "cc // Precio: $"+ precioMostrar);
			return true;	
		}
	}
