...
public class main{
	...
	public static void main(String[] args) {
	 ...
	 System.out.println("Vehículo que contiene en el modelo la letra ‘Y’: " + con.buscarAutoLetra('Y').getMarcaAuto() + " " + con.buscarAutoLetra('Y').getModeloAuto() + " " + con.buscarAutoLetra('Y').getPrecio());
	 espacio();
